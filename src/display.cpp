...
void DrawOutputImage()
{
	...
	// Set a sensible default position and size for the image window on first use
	// Users can still move/resize it; these only apply the first time the window appears
